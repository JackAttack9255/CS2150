...
/** Constructor
 * \brief Creates a graph of middle earth
 * @param xsize - integer representing x dimension of graph
 * @param ysize - integer representing y dimension of graph
 * @param num_cities - amount of cities to include in the graph, must be between 0 and 40
 * @param seed - integer to assist the randomness of the graph generation
 * @return - nothing, just a constructor
 */
 ...
 * @return - nothing, just couts to terminal
 */
// The Mouth of Sauron!
 ...
 * @param city1 - a first city
 * @param city2 - a second city to see the distance from the first
 ...
 * @param length - how many cities to travel to
