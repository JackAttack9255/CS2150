...
mergeSort:
	;; first half of array
	cmp rsi, rdx		; compare left to right
	jge done		; if left > right, done
	push rsi		; left
	push rdx		; right
	add rdx, rsi		; add left and right
	shr rdx, 1		; divide sum by 2
	push rdx		; this value will be the middle of the array
	...
	;; merge
	call merge		; finished sorting so merge
